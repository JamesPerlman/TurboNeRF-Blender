...
RENDER_CAM_HEX_QUAD_FRONT_SENSOR_SIZE_ID = "front_sensor_size"
RENDER_CAM_HEX_QUAD_BACK_SENSOR_SIZE_ID = "back_sensor_size"
RENDER_CAM_HEX_QUAD_SENSOR_LENGTH_ID = "sensor_length"
